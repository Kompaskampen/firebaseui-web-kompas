...
firebaseui.auth.widget.handler.onSignUpSubmit_ = function (app, component) {
  ...
  var emailPassCred = firebase.auth.EmailAuthProvider.credential(
    email,
    password
  );
  // Sign up new account.
        ...
        switch (normalizedError["code"]) {
          ...
          case "auth/too-many-requests":
            errorMessage = firebaseui.auth.soy2.strings
              .errorTooManyRequestsCreateAccount()
              .toString();
 ...
 * @private
 */
firebaseui.auth.widget.handler.onEmailExists_ = function (
  app,
  component,
  email,
  emailExistsError
        ...
        if (!signInMethods.length) {
          ...
          firebaseui.auth.widget.handler.handle(
            ...
            firebaseui.auth.soy2.strings
              .errorAnonymousEmailBlockingSignIn()
              .toString()
          );
        } else {
