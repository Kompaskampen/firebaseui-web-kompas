...
goog.scope(function () {
  ...
  element.newPassword.togglePasswordVisible = function () {
    ...
    var newPasswordElement =
      element.newPassword.getNewPasswordElement.call(this);
  ...
  element.newPassword.validate_ = function (newPasswordElement, errorElement) {
    ...
    if (!password) {
      ...
      element.show(
        errorElement,
        firebaseui.auth.soy2.strings.errorPasswordOutOfBounds().toString()
      );
      return false;
    } else if (
      !/[a-z]/.test(password) ||
      ...
      element.show(
        errorElement,
        firebaseui.auth.soy2.strings.errorPasswordWeak().toString()
      );
      return false;
    } else {
  ...
  element.newPassword.initNewPasswordElement = function () {
    ...
    var errorElement =
      element.newPassword.getNewPasswordErrorElement.call(this);
